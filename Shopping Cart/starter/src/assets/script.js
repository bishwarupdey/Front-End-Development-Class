...
/* Create an array named products which you will use to add all of your product object literals that you create above. */
...
function cartTotal() {
  let finalTotal = 0;
    for (let i = 0; i < cart.length; i++) {
      finalTotal += cart[i].quantity * cart[i].price;
    }
